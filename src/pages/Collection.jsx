...
const Collection = () => {
  return (
    <div>
                  ...
                  >
                    ...
                    <div className="p-4">
                      <h2 className="font-bold text-lg">
                       ...
                       <button   className="inline-flex items-center gap-2  bg-black px-5 py-2 rounded-2xl text-amber-50 hover:bg-amber-400 transition"><a  href="https://wa.link/nfkm94" target="_blank"> Place Order</a></button>
                    </div>
      ...
      <div className="bg-amber-950 px-7 flex  justify-between py-4 text-amber-50">
        <div className="text-amber-50">
          <h1 className="font-bold">Order Easily on WhatsApp</h1>
          <p>Chat with Us now to place your Order or get expert Advise</p>
          
          <button   className="inline-flex items-center gap-2  bg-green-400 px-5 py-2 rounded-2xl text-amber-50 hover:bg-amber-400 transition"><div className="flex gap-2"> <div><Phone /></div><div><a  href="https://wa.link/nfkm94" target="_blank">Chat On WhatsApp</a></div></div></button>
        </div>
